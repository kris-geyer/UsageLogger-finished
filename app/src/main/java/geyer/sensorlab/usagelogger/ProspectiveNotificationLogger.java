...
public class ProspectiveNotificationLogger extends NotificationListenerService {
    ...
    public void onNotificationPosted(StatusBarNotification sbn) {
        ...
        /*
        How to cancel all notifications from happening.     
        ...
        */
        storeData("note added: " + (ai != null ?  pm.getApplicationLabel(ai) :(sbn.getPackageName())));
    ...
    public void onNotificationRemoved(StatusBarNotification sbn) {
        ...
        storeData("note removed: " + (ai != null ?  pm.getApplicationLabel(ai) :(sbn.getPackageName())));
        super.onNotificationRemoved(sbn);
    }
